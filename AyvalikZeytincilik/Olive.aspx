<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Olive.aspx.cs" Inherits="AyvalikZeytincilik.Olive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        app.controller('Zeytin', function ($scope, $http) {
            $http.get("../Json/AyvalikKirmaZeytin.json").then(function (response) {
                $scope.veri = response.data.Zeytin;
            });
        });
    </script>
</asp:Content>
